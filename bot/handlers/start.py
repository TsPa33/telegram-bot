...
async def demo_sites(callback: CallbackQuery):
    ...
    await callback.message.answer(
        "🌐 <b>Готові рішення для автобізнесу</b>\n\n"
        "Оберіть приклад рішення за напрямком бізнесу:\n"
        "• Інтернет-магазин запчастин\n"
        "• Сайт-візитка автосервісу\n"
        "• Шиномонтаж\n"
        "• СТО\n"
        "• Евакуатор\n"
        "• Автоелектрик\n"
        "• Авторозборка\n\n"
        "Ми адаптуємо сайт під ваш бізнес:\n"
        "• дизайн і стиль\n"
        "• структуру сторінок\n"
        "• товари та послуги\n"
        "• галереї\n"
        ...
        "• заявки із сайту прямо в Telegram\n\n"
        "Це лише приклади. Ми можемо змінити структуру, блоки, дизайн і функціонал під особливості вашого бізнесу.",
        parse_mode="HTML",
